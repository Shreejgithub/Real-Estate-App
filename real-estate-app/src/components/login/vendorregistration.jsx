...
const VendorRegistration = () => {
  ...
  const handleRegistration = async (e) => {
    ...
    try {
      console.log("Attempting to register vendor...");
      ...
      await axios.post('http://localhost:8001/api/vendors/create', userData);
      ...
      Swal.fire({
        ...
        // Redirect to the vendor dashboard after the notification
     ...
     <img src="../images/quikr_homes_logo.png" alt="Logo" className="login-logo" />
      ...
      <div className="register-now">
        <p>
          ...
          <Link to="/vendorlogin" className="register-link">
            Login now
          </Link>
        </p>
      </div>
